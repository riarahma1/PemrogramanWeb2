        ...
        <div class="col-8">
            ...
            <form action="/books/update/<?= $books['id']; ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('sampul')) ? 'is-invalid' : '';?>" id="sampul" name="sampul" value="<?= (old('sampul')) ? old('sampul') : $books['sampul'] ?>">
